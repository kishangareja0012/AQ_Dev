...
<style>
	p.vendor_not_found_tag{border-radius: 25px;border: 2px solid #c9372c;padding: 45px;width: 100%;height: 130px;text-align: center;font-size: 24px;line-height: 1.5em;font-weight: bold;color: #e67e22;margin-top:10px; }
	@media (max-width: 576px) and (min-width: 0px){
		p.vendor_not_found_tag {height: 155px!important; }
...
<div class="card-content-div">
	...
	<div class="grid-list-2">
		<?php
if (!empty($quotedata->item_sample)) {$path = asset('public/assets/images/quotes/' . $quotedata->item_sample);} else { $path = asset('public/assets/images/default.jpeg');}
?>
		...
		<div class="numberfo-viwe-vendor" style="height:70px;">
			...
			<p><b>Request sent to <b> <?php if ($vendors_count_sent > 200) {echo "more than 200";} else {echo $vendors_count_sent;}?></b> Vendors</b></p>
			...
			@endif
			@else
				<p><b>Our experts working with vendors to get you best price</b></p>
			@endif
		</div>
	...
	<div class="card-table-list ">
		...
		<ul id="quote_content">
			<?php if (count($quoteresponses) > 0) {?>
				...
				@endforeach
			<?php } else {?>
					<p class="vendor_not_found_tag">Our experts working with vendors to get you best price</p>
			<?php }?>
		</ul>
