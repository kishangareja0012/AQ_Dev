...
@section('title', 'View your Requests')
@section('content')
<style>
	li.last-child.pull-right {color: #fff; background: #0c9e54; padding: 10px; border-radius: 48px; } 
	.text-right.pull-right.total-request.total-response {padding-top: 12px; }
	.vendor-from-search {width: 100%; }
</style>
<div class="card-content-div  vendor-requests" id="quote_content">
	<ul class="breadcrumb">
...
<script>
	...
	function load_quote(){
		$.ajax ({
			url:'<?php echo url("vendor/ajax_load_quote"); ?>',
			dataType:"JSON",
